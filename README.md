...
| 🏗️ **現代化架構** | **v3.2.0** 採用分層架構 (Layered Architecture) 與物件導向設計，高內聚低耦合 |
...
| 📊 **技術指標** | RSI 相對強弱指標（6日週期）+ MA 三段膠囊燈號（20/50/200日站位 + 多空排列膠囊框） |
...
```
更新時間    名稱/代號      K線  漲跌%    價格   量比   RSI    MA (20/50/200)
────────────────────────────────────────────────────────────────────────
半導體     NVDA          📊  +3.58%  181.57  1.88  ▲65  [ ■ ■ ■ ] (多頭)
金融服務   騰訊控股      📊  +2.15%  385.20  1.25  ▼45    ■ ■ ─   (次新/缺)
科技       TSLA          📊  -2.15%  242.30  2.34  ▼28  [ ■ ■ ■ ] (空頭)
```
